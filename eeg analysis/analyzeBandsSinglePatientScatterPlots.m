...
filename = sprintf('pat%02d_part1_results_bands.mat', patientNum);
...
if exist(filename, 'file')
    ...
    L_XY = squeeze(seizureResult.L_XY_all(1, :, :));
    R = squeeze(seizureResult.R_all(1, :, :));
    % Analyze scatter plot for this seizure
    analyzeScatterPlot(L_XY, R, ...
        seizureResult.selectedPairNames, seizureResult.timePointNames, patientNum, szIdx, sprintf('outliers_pat%02d_sz%d_alpha.csv', patientNum, szIdx));
